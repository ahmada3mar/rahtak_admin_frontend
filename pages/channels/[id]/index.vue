<template>
  ...
  <div>
    <div v-if="response">
      <div class="py-4 mb-8 rounded-md bg-white-bk" v-if="response">
        <UCard class="w-full" :ui="{
          ...
          <div v-if="$can('update channels')" class="flex justify-end">
            ...
            <NuxtLink :to="{ name: 'channels-id-edit', params: { id: resource.id } }">
        ...
        <UCard class="w-full" :ui="{
          ...
          <UTable :ui="{ th: { base: 'text-left' } }" :rows="response?.channels" :columns='[
            ...
            <template #id-data="{ row }">
              <NuxtLink :to="{ name: 'webhook-id', params: { id: row?.id } }"
